...
song3 = Song("Lose Yourself", "Eminem", "Rap")
song4 = Song("Shape of You", "Ed Sheeran", "Pop")

print(Song.count)         # Output: 4
print(Song.artists)       # Output: ['Jay-Z', 'Beyonce', 'Eminem', 'Ed Sheeran']
print(Song.genres)        # Output: ['Rap', 'Pop']
print(Song.genre_count)   # Output: {'Rap': 2, 'Pop': 2}
print(Song.artist_count)  # Output: {'Jay-Z': 1, 'Beyonce': 1, 'Eminem': 1, 'Ed Sheeran': 1}
